...
\caption{Project arc across 52 experiments. Y-axis is EER on a log scale. Each modality flagship dropped roughly two orders of magnitude from its anchor: audio 97 \%, image 89 \%, fusion 93 \% relative EER reduction.}
